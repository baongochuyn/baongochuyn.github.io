        ...
        <div>
          ...
          <header className="mb-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight">{skill.name}</h1>
            </div>
            <p className="text-slate-400 text-sm">Détail de la compétence, contexte d&apos;usage et retours d&apos;expérience.</p>
