...
export const presentationSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Ce qui me motive particulièrement dans le développement est la compréhension d'un besoin métier, la conception d'une solution technique adaptée et la capacité à améliorer des processus existants.`,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `À court terme, mon objectif est de consolider mes compétences sur C# et .NET, React et le développement frontend moderne, ainsi que les bases de données SQL.`,
      `Je souhaite également approfondir des aspects plus avancés comme l'architecture logicielle, les tests automatisés et les bonnes pratiques de développement (CI/CD, qualité du code).`,
